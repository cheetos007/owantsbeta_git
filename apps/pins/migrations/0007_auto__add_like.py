...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pins_like', (
            ...
            ('created_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pins_like_created_set', null=True, to=orm['auth.User'])),
            ('modified_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pins_like_modified_set', null=True, to=orm['auth.User'])),
