...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pin.video_id'
        db.add_column('pins_pin', 'video_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Pin.video_parser'
        db.add_column('pins_pin', 'video_parser', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pin.video_id'
        db.delete_column('pins_pin', 'video_id')

        # Deleting field 'Pin.video_parser'
        db.delete_column('pins_pin', 'video_parser')
    ...
    models = {
        ...
        'pins.pin': {
            ...
            'original_image_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'video_parser': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
