...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field recommended_users_to_follow on 'Category'
        db.create_table('pins_category_recommended_users_to_follow', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['pins.category'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('pins_category_recommended_users_to_follow', ['category_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field recommended_users_to_follow on 'Category'
        db.delete_table('pins_category_recommended_users_to_follow')
