...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pins_category', 'image', self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Category.show_upon_signup'
        db.add_column('pins_category', 'show_upon_signup', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.image'
        db.delete_column('pins_category', 'image')

        # Deleting field 'Category.show_upon_signup'
        db.delete_column('pins_category', 'show_upon_signup')
