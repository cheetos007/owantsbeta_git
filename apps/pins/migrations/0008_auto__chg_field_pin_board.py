...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pin.board'
        db.alter_column('pins_pin', 'board_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pins.Board'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Pin.board'
        db.alter_column('pins_pin', 'board_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pins.Board']))
