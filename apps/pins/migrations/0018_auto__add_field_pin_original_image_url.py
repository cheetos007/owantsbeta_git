...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pin.original_image_url'
        db.add_column('pins_pin', 'original_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pin.original_image_url'
        db.delete_column('pins_pin', 'original_image_url')
