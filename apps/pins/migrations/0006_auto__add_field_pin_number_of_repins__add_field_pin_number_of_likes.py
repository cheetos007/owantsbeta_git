...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pin.number_of_repins'
        db.add_column('pins_pin', 'number_of_repins', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Pin.number_of_likes'
        db.add_column('pins_pin', 'number_of_likes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pin.number_of_repins'
        db.delete_column('pins_pin', 'number_of_repins')

        # Deleting field 'Pin.number_of_likes'
        db.delete_column('pins_pin', 'number_of_likes')
