...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DefaultBoard'
        db.create_table('pins_defaultboard', (
            ...
            ('created_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pins_defaultboard_created_set', null=True, to=orm['auth.User'])),
            ('modified_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pins_defaultboard_modified_set', null=True, to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('name_lv', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pins.Category'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('pins', ['DefaultBoard'])


    def backwards(self, orm):
        
        # Deleting model 'DefaultBoard'
        db.delete_table('pins_defaultboard')
