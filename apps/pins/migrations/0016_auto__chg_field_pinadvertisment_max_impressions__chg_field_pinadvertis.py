...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PinAdvertisment.max_impressions'
        db.alter_column('pins_pinadvertisment', 'max_impressions', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'PinAdvertisment.active_to'
        db.alter_column('pins_pinadvertisment', 'active_to', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PinAdvertisment.max_impressions'
        db.alter_column('pins_pinadvertisment', 'max_impressions', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'PinAdvertisment.active_to'
        db.alter_column('pins_pinadvertisment', 'active_to', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 18, 13, 30, 17, 804000)))
