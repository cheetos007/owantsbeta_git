...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pin.pin_source'
        db.add_column('pins_pin', 'pin_source', self.gf('django.db.models.fields.CharField')(default='url', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pin.pin_source'
        db.delete_column('pins_pin', 'pin_source')
