...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invite_friends_emailinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='emailinvite_created_set', to=orm['auth.User'])),
            ...
            ('accepted_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='emailinvite_accepted_set', null=True, to=orm['auth.User'])),
            ('personal_note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255)),
        ))
        db.send_create_signal('invite_friends', ['EmailInvite'])


    def backwards(self, orm):
        
        # Deleting model 'EmailInvite'
        db.delete_table('invite_friends_emailinvite')
