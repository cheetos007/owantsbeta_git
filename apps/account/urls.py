...
urlpatterns = patterns("",
    ...
    url(r"^login/popup/$", "account.views.login", name="login_popup", kwargs={'template_name': "account/login_popup.html"}),
    url(r"^login_error/$", "account.views.login_error", name="login_error"),
