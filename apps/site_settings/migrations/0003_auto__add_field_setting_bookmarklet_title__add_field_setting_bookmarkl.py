...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.bookmarklet_title'
        db.add_column('site_settings_setting', 'bookmarklet_title', self.gf('django.db.models.fields.CharField')(default='owants', max_length=50), keep_default=False)

        # Adding field 'Setting.bookmarklet_title_en'
        db.add_column('site_settings_setting', 'bookmarklet_title_en', self.gf('django.db.models.fields.CharField')(default='owants', max_length=50, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Setting.bookmarklet_title'
        db.delete_column('site_settings_setting', 'bookmarklet_title')

        # Deleting field 'Setting.bookmarklet_title_en'
        db.delete_column('site_settings_setting', 'bookmarklet_title_en')
