...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.twitter_handle'
        db.add_column('site_settings_setting', 'twitter_handle', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Setting.twitter_handle'
        db.delete_column('site_settings_setting', 'twitter_handle')
