...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.google_analytics_tracking_id'
        db.add_column('site_settings_setting', 'google_analytics_tracking_id', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Setting.google_analytics_tracking_id'
        db.delete_column('site_settings_setting', 'google_analytics_tracking_id')
