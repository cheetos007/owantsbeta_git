...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.mailing_address'
        db.add_column('site_settings_setting', 'mailing_address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Setting.mailing_address'
        db.delete_column('site_settings_setting', 'mailing_address')
