...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Setting.allow_tweet'
        db.add_column('site_settings_setting', 'allow_tweet', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Setting.allow_tweet'
        db.delete_column('site_settings_setting', 'allow_tweet')
    ...
    models = {
        ...
        'site_settings.setting': {
            ...
            'allow_facebook_share': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
