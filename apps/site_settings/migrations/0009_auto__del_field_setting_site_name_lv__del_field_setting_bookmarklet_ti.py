...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Setting.site_name_lv'
        db.delete_column('site_settings_setting', 'site_name_lv')

        # Deleting field 'Setting.bookmarklet_title_lv'
        db.delete_column('site_settings_setting', 'bookmarklet_title_lv')

        # Adding field 'Setting.site_name_es'
        db.add_column('site_settings_setting', 'site_name_es', self.gf('django.db.models.fields.CharField')(default='owants', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Setting.bookmarklet_title_es'
        db.add_column('site_settings_setting', 'bookmarklet_title_es', self.gf('django.db.models.fields.CharField')(default='owants', max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Setting.site_name_lv'
        db.add_column('site_settings_setting', 'site_name_lv', self.gf('django.db.models.fields.CharField')(default='owants', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Setting.bookmarklet_title_lv'
        db.add_column('site_settings_setting', 'bookmarklet_title_lv', self.gf('django.db.models.fields.CharField')(default='owants', max_length=50, null=True, blank=True), keep_default=False)

        # Deleting field 'Setting.site_name_es'
        db.delete_column('site_settings_setting', 'site_name_es')

        # Deleting field 'Setting.bookmarklet_title_es'
        db.delete_column('site_settings_setting', 'bookmarklet_title_es')
